...
public class UserBadgeService implements YCrudService<UserBadge, UUID, UserBadgeDto, UserBadgeBodyDto>, YSearchService<UserBadge, UUID, UserBadgeDto> {
